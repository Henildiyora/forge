...
from swarm.agents.captain.graph import build_captain_graph
from swarm.agents.librarian.agent import LibrarianAgent
...
def build_default_deploy_dependencies(
    ...
    from swarm.agents.cicd_specialist.agent import CICDSpecialistAgent
    from swarm.agents.docker_specialist.agent import DockerSpecialistAgent

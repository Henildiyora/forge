...
from forge.agents.k8s_specialist.kubectl_client import CommandResult, KubectlClient
from forge.agents.librarian.ast_analyzer import ASTAnalyzer
from forge.agents.sandbox_tester.agent import SandboxTesterAgent
from forge.agents.sandbox_tester.smoke_tests import run_smoke_tests
from forge.agents.sandbox_tester.vcluster_client import VClusterClient
...
async def test_sandbox_tester_passes_validation_for_healthy_sandbox(
    ...
    kubectl_runner = StubKubectlRunner(
        [
            ...
            CommandResult(
                stdout=(
                    '{"metadata":{"name":"api-123","namespace":"devops-forge"},'

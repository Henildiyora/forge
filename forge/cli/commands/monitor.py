...
from forge.agents.watchman.agent import MonitoringSnapshot, WatchmanAgent
...
from forge.orchestrator.workflows.deploy_workflow import build_default_deploy_dependencies


def monitor(
    service: Annotated[str, typer.Argument()],
    namespace: Annotated[str, typer.Option("--namespace")] = "devops-forge",
    ...
    if result.fix_diff is not None:
        typer.echo(f"Proposed remediation: {result.fix_diff}")
